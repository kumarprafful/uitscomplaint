							      ...
							      <div class="modal-content">
							        ...
							        <div class="modal-body" style="padding:40px 50px;">
							          <form role="form" action="" method="post">
							              ...
							              <input type="text" id="remark_input" name="remarks" class="form-control" onkeydown="noSpace(this,event)" style="width: 100% !important;" required="true">
